...
// screens
{
  /* <div data-radix-popper-content-wrapper="" style="position: fixed; left: 0px; top: 0px; transform: translate(77px, 278px); min-width: max-content; z-index: auto; --radix-popper-available-width: 1031px; --radix-popper-available-height: 577px; --radix-popper-anchor-width: 113px; --radix-popper-anchor-height: 44px; --radix-popper-transform-origin: 200px -8px;">
   <aside class="flex flex-col gap-16 rounded-16 p-16 shadow-dropdown light:bg-bg-primary dark:bg-bg-secondary w-[--radix-hover-card-content-available-width] min-w-[296px] max-w-[400px] data-state-open:animate-in data-state-closed:animate-out [--tw-in-duration:150ms] [--tw-out-duration:150ms] [--tw-enter-opacity:0] [--tw-exit-opacity:0] min-720:[--tw-enter-scale:0.96] min-720:[--tw-exit-scale:0.96]" data-side="bottom" data-align="center" data-state="open" style="--radix-hover-card-content-transform-origin: var(--radix-popper-transform-origin); --radix-hover-card-content-available-width: var(--radix-popper-available-width); --radix-hover-card-content-available-height: var(--radix-popper-available-height); --radix-hover-card-trigger-width: var(--radix-popper-anchor-width); --radix-hover-card-trigger-height: var(--radix-popper-anchor-height);">
      <div class="grid gap-12 rounded-16 p-16 light:bg-bg-secondary dark:bg-bg-tertiary grid-cols-1">
         <div data-radix-aspect-ratio-wrapper="" style="position: relative; width: 100%; padding-bottom: 62.4376%;">
            <div class="relative overflow-hidden rounded-8 bg-bg-secondary after:absolute after:inset-0 after:rounded-8 after:shadow-image-inset" style="position: absolute; inset: 0px;"><img src="https://upcdn.io/FW25bBB/image/static/dictionary/web_screen_patterns/dashboard_01.png?f=webp&amp;w=1920&amp;q=85&amp;fit=shrink-cover" alt="Dashboard example" class="h-full w-full object-cover"></div>
         </div>
      </div>
      <p class="text-body-small text-fg-secondary">Dashboard pattern provides a high-level overview of data.</p>
      <span style="position: absolute; top: 0px; transform-origin: center 0px; transform: rotate(180deg); left: 0px;">
         <svg class="invisible w-[--radix-hover-card-content-available-width] min-w-[296px] max-w-[400px]" width="10" height="8" viewBox="0 0 30 10" preserveAspectRatio="none" style="display: block;">
